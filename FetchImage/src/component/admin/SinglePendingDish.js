...
import { getSinglePendingDishes} from '../../service/FoodService';

import './DetailPageStyle.css'
export class SinglePendingDish extends Component {
    ...
    componentDidMount(){
        getSinglePendingDishes(this.state.did)
...
export default SinglePendingDish